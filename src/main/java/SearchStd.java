...
public class SearchStd extends StdList{
    ...
    public void by_name(String name){
        ...
        if (flag == 0){
            show_msg("There is no student with this name!");
        }
        else{
            Button b1 = new Button("Close");
            b1.setOnAction(event -> {
    ...
    public void by_lastname(String lastname){
        int flag = 0;
        VBox vbox = new VBox();
        for(int i =0; i<std_count;i++){
            if (lastname.equals(lastnameL.get(i))){
                vbox.getChildren().add(print(i));
                flag = 1;
            }
        ...
        if (flag == 0){
            show_msg("There is no student with this last name!");
        }
        else{
            Button b1 = new Button("Close");
            b1.setOnAction(event -> {
            ...
            Scene print_std = new Scene(vbox,650,650);
            stage.setScene(print_std);
            stage.setTitle("Search student by last name");
            stage.setAlwaysOnTop(true);
            stage.setResizable(false);
            stage.show();
        }
    ...
    public void by_major(String major){
        int flag = 0;
        VBox vbox = new VBox();
        for(int i =0; i<std_count;i++){
            if (major.equals(majorL.get(i))){
                vbox.getChildren().add(print(i));
                flag = 1;
            }
        ...
        if (flag == 0){
            show_msg("There is no student with this major!");
        }
        else{
            Button b1 = new Button("Close");
            b1.setOnAction(event -> {
            ...
            Scene print_std = new Scene(vbox,650,650);
            stage.setScene(print_std);
            stage.setTitle("Search student by major");
            stage.setAlwaysOnTop(true);
            stage.setResizable(false);
            stage.show();
        }
    ...
    public void by_id(int std_id){
        ...
        if (flag == 0){
            ...
            Scene print_std = new Scene(vbox,650,650);
            stage.setScene(print_std);
            stage.setTitle("Search student by student number");
            stage.setAlwaysOnTop(true);
            stage.setResizable(false);
            stage.show();
        }
